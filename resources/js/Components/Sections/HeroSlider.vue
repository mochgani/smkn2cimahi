    ...
    >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div class="flex flex-col justify-center">
                ...
                <h1 class="text-5xl md:text-6xl font-extrabold leading-[1.05] tracking-tightest text-ink mb-6 max-w-xl">
                    {{ slides[currentSlide].title }}
                </h1>

                <p class="text-base leading-relaxed text-muted-soft max-w-md mb-8">
            ...
            <div class="relative aspect-[4/3] overflow-hidden bg-line-soft">
                <!-- Gambar jika ada -->
                <img
